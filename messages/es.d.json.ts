...
declare const messages: {
  ...
  formFields: {
    ...
    iban: {
      invalidCountryCode: 'Codigo de pais invalido'
      unknownCountryCode: 'Codigo de pais desconocido'
      invalidChecksum: 'Suma de verificacion invalida'
      expectedLength: 'Se esperan {length} caracteres'
      validIban: 'IBAN valido'
      invalid: 'Invalido'
    }
    ip: {
      cidrNotAllowed: 'Notacion CIDR no permitida'
      invalidCidr: 'Notacion CIDR invalida'
      invalidCidrPrefix: 'Prefijo CIDR invalido'
      ipv6Only: 'Solo IPv6'
      ipv4CidrRange: 'CIDR IPv4 debe ser 0-32'
      ipv4Only: 'Solo IPv4'
      ipv6CidrRange: 'CIDR IPv6 debe ser 0-128'
      invalidIp: 'Direccion IP invalida'
      valid: 'Valida'
      invalid: 'Invalida'
    }
    url: {
      protocolNotAllowed: 'Protocolo "{protocol}" no permitido'
      invalidFormat: 'Formato de URL invalido'
      validUrl: 'URL valida'
      invalid: 'Invalida'
    }
  }
