...
export const TwoFactorDisableForm = memo(function TwoFactorDisableForm({
  error,
  isPending,
  onSubmit,
  onCancel,
  ...
  return (
    <div className="grid gap-4">
      <h3 className="text-lg font-medium">{t('disableTitle')}</h3>
      <p className="text-muted-foreground text-sm">{t('disableDesc')}</p>
      <Form {...form}>
