...
import { PLATFORM_CONFIGS } from './form-social-field.data'
import type { BaseFormFieldProps } from './form-field.types'
import type { SocialPlatform, SocialValue } from './form-social-field.data'
import type {
  FieldPath,
  FieldValues,
...
export type { SocialPlatform, SocialValue } from './form-social-field.data'
...
const SocialContent = memo(function SocialContent({
  ...
  const value = useMemo(
    () =>
      (field.value || { platform: defaultPlatform, handle: '' }) as SocialValue,
